...
\caption[Distance Projections.]{\label{fig:horizon-finding}Direction of obstacles is determined by projecting them onto the horizon line}
\end{figure}
...
\caption[Routemaking.]{\label{fig:routemaking}Routemaking}
\end{figure}